...
static inline HMM_Quat HMM_QFromAxisAngle_RH(vec3 Axis, float AngleOfRotation)
{
...
static inline HMM_Quat HMM_QFromAxisAngle_LH(vec3 Axis, float AngleOfRotation)
{
